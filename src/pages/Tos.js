...
export default () => (
  <React.Fragment>
    <h1>Terms and Conditions for Code Kelvin</h1>

    <h2>Introduction</h2>

    <p>
      These Website Standard Terms and Conditions written on this webpage shall manage your use of
      our website, Code Kelvin accessible at https://pay.codekelvin.com.
    </p>
    ...
    <p>
      Other than the content you own, under these Terms, Code Kelvin and/or its licensors own all
    ...
    <p>
      Certain areas of this Website are restricted from being access by you and Code Kelvin may
    ...
    <p>
      ...
      Content, you grant Code Kelvin a non-exclusive, worldwide irrevocable, sub licensable license
      to use, reproduce, adapt, publish, translate and distribute it in any and all media.
    </p>

    <p>
      Your Content must be your own and must not be invading any third-party’s rights. Code Kelvin
    ...
    <p>
      This Website is provided "as is," with all faults, and Code Kelvin express no representations
    ...
    <p>
      In no event shall Code Kelvin, nor any of its officers, directors and employees, shall be held
      liable for anything arising out of or in any way connected with your use of this Website
      whether such liability is under contract. Code Kelvin, including its officers, directors and
    ...
    <p>
      You hereby indemnify to the fullest extent Code Kelvin from and against any and/or all
    ...
    <p>
      Code Kelvin is permitted to revise these Terms at any time as it sees fit, and by using this
    ...
    <p>
      The Code Kelvin is allowed to assign, transfer, and subcontract its rights and/or obligations
    ...
    <p>
      These Terms constitute the entire agreement between Code Kelvin and you in relation to your
    ...
    <p>
      ...
      th, and you submit to the non-exclusive jurisdiction of the state and federal courts located
      in th for the resolution of any disputes.
    </p>
