...
export default () => (
  <React.Fragment>
    ...
    <p>Effective date: July 18, 2018</p>

    <p>
      Code Kelvin ("us", "we", or "our") operates the https://pay.codekelvin.com website (the
      "Service").
    </p>
    ...
    <p>
      ...
      This Privacy Policy for Code Kelvin is powered by{' '}
    ...
    <p>
      ...
      and Conditions, accessible from https://pay.codekelvin.com
    </p>
    ...
    <p>Code Kelvin uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      If you are located outside Thailand and choose to provide information to us, please note that
      we transfer the data, including Personal Data, to Thailand and process it there.
    </p>
    <p>
    ...
    <p>
      Code Kelvin will take all steps reasonably necessary to ensure that your data is treated
    ...
    <p>
      Code Kelvin may disclose your Personal Data in the good faith belief that such action is
      necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of Code Kelvin</li>
    ...
    <ul>
      <li>By visiting this page on our website: https://pay.codekelvin.com/privacy</li>
    </ul>
  </React.Fragment>
)
